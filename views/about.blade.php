  ...
  <div class="flex items-center gap-10">
    <nav class="flex gap-8 items-center relative">
      ...
      <div class="relative group">
        ...
        <div class="absolute top-full left-0 bg-white rounded-xl shadow-md flex-col p-2 hidden group-hover:flex z-[999]">
              <a href="{{ url('/about#intro') }}" class="px-4 py-2 hover:bg-gray-200 text-black font-normal text-base">Introduction</a>
      ...
      <div class="relative group">
        ...
        <div class="absolute top-full left-0 bg-white rounded-xl shadow-md flex-col p-2 hidden group-hover:flex z-[999]">
          <a href="{{ url('/roadmap') }}" class="px-4 py-2 hover:bg-gray-200 text-black font-normal text-base">Roadmap</a>
        </div>
      </div>
    </nav>
    <div class="relative">
